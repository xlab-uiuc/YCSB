...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--output_folder", help="The path to the output folder generated by the script.")
    args = parser.parse_args()

    if args.output_folder:
        overall_dict = parse_output(args.output_folder)
        # write_report(overall_dict)
        write_excel(overall_dict, "report/" + args.output_folder + ".xlsx")
    else:
        parser.print_help()
